...
export default function SonsDaughtersPage({ onBack }: SonsDaughtersPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-amber-500/10 blur-[100px] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-white/5 rounded-full flex items-center justify-center border border-white/15 backdrop-blur-md shadow-2xl relative group overflow-hidden">
            {/* Soft inner glow */}
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-amber-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <img
            ...
            <span className="absolute bottom-1 right-1 bg-indigo-900 p-0.5 rounded-full border border-indigo-550" title="Sons & Daughters">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-white tracking-tight flex flex-col gap-1">
            ...
            <span className="text-xs text-indigo-400 uppercase tracking-widest font-bold mt-1">Apostolic Mentorship updates ✨</span>
          </h2>
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-3xl border border-white/10 relative overflow-hidden">
            ...
            {status === 'success' ? (
              <div className="text-center py-6 animate-scale-up">
                <div className="w-16 h-16 bg-indigo-500/10 text-indigo-400 rounded-full flex items-center justify-center mx-auto border border-indigo-500/20 shadow-lg shadow-indigo-500/5">
                  <CheckCircle className="w-8 h-8" />
                </div>
                <h3 className="mt-4 text-xl font-bold text-white">Welcome to the Family!</h3>
                ...
                <button
                  ...
                  className="mt-6 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-750 text-white font-bold text-sm rounded-xl transition-all shadow-lg hover:shadow-indigo-500/20 cursor-pointer border-none"
                >
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-3 px-4 bg-indigo-650 hover:bg-indigo-700 disabled:bg-indigo-800/50 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-indigo-950/20 active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer border-none"
                  >
                    {status === 'submitting' ? (
                      <>
