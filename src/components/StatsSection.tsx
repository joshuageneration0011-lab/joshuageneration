  ...
  return (
    <section className="relative py-20 bg-[#0a0f1e] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center mb-16 pb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10 sm:gap-14">
            ...
            >
              <svg className="w-12 h-12 text-[#1DB954] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(29,185,84,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-12 h-12 text-[#ab57f2] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(171,87,242,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-12 h-12 text-[#00A8E1] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(0,168,225,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-12 h-12 text-[#F43F5E] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(244,63,94,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-13.5 h-10.5 text-[#EF4444] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(239,68,68,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              <svg className="w-12 h-12 text-[#F59E0B] hover:brightness-125 hover:drop-shadow-[0_0_12px_rgba(245,158,11,0.4)] transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
