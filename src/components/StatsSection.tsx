...
export default function StatsSection(_props: StatsSectionProps) {
  const platforms = [
    {
      name: 'Spotify',
      url: 'https://open.spotify.com/show/033NsdQtAF4RjTtaJwlXWk',
      color: '#1DB954',
      glow: 'rgba(29,185,84,0.5)',
      svg: (
        <svg className="w-16 h-16 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Apple Podcasts',
      url: 'https://podcasts.apple.com/us/podcast/joshuas-generation-podcast/id6789819767',
      color: '#ab57f2',
      glow: 'rgba(171,87,242,0.5)',
      svg: (
        <svg className="w-16 h-16 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Amazon Music',
      url: 'https://music.amazon.com/podcasts/fba19ef3-b19d-4556-bef4-a2f9531b8490',
      color: '#00A8E1',
    ...
    {
      name: 'Pocket Casts',
      url: 'https://pca.st/itunes/6789819767',
      color: '#F43F5E',
    ...
    {
      name: 'Deezer',
      url: 'https://www.deezer.com/show/1003390762',
      color: '#EF4444',
      glow: 'rgba(239,68,68,0.5)',
      svg: (
        <svg className="w-18 h-14 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Player FM',
      url: 'https://player.fm/series/series-3740553',
      color: '#F59E0B',
    ...
    <section className="relative py-24 bg-[#0a0f1e] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center">
          <span className="text-white/40 text-xs font-bold uppercase tracking-[0.2em] mb-12 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-12 sm:gap-18">
            {platforms.map((platform) => (
              <a
                ...
                style={{ '--glow-color': platform.glow } as React.CSSProperties}
                title={`Listen on ${platform.name}`}
              >
                <div 
                  className="transition-all duration-300 group-hover:brightness-125 group-hover:drop-shadow-[0_0_16px_var(--glow-color)]"
                  style={{ color: platform.color }}
                >
                  {platform.svg}
                </div>
                <span className="text-white/50 text-xs font-medium tracking-wide group-hover:text-white transition-colors duration-300 mt-1">
                  {platform.name}
                </span>
              </a>
            ))}
