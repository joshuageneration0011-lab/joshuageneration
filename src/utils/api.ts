...
export const api = {
  ...
  async generateImage(params: { prompt: string; size?: string; n?: number; model?: string; aspect_ratio?: string; image?: string; engine?: string; bannerbear_template?: string }): Promise<{
    success: boolean;
    output: string[];
    id?: string;
    prompt?: string;
