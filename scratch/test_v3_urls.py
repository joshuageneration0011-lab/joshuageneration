...
def main():
    ...
    try:
        ...
        # Test both base URLs with OAuth2 token
...
BODY='{"amount":10,"currency":"NGN","reference":"JG-TEST-v3-123","redirect_url":"https://joshuasgeneration.com","customer":{"email":"test@test.com","name":"Test User"},"customizations":{"title":"Joshua Generation"}}'

echo "=== api.flutterwave.com/v3/payments ==="
...
echo ""
echo "=== developersandbox-api.flutterwave.com/v3/payments ==="
