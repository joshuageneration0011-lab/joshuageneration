...
BODY='{"amount":10,"currency":"NGN","reference":"JG-TEST-charges-'"$(date +%s)"'","redirect_url":"https://joshuasgeneration.com","customer":{"email":"test@test.com","name":"Test User"}}'

echo "=== POST /charges ==="
curl -s -X POST 'https://developersandbox-api.flutterwave.com/charges' \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TOKEN" \
  -d "$BODY" | python3 -c "import sys,json; d=json.load(sys.stdin); print(json.dumps(d, indent=2))"
"""
